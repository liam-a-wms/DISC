...
public class ScenarioCompressor {
	 ...
	 * 
	 * @param input The input String to be read
	 */
	...
	/**
	 * Decompresses the given file into the internal array. Will clear the internal array.
	 * 
	...
	/**
	 * "Decompresses" the given String into the internal array. Will clear the internal array.
	 * 
	...
	/**
	 * Removes any empty scenarios that may have been accidentally added during parsing of a file.
	 */
	private void clean() {
		Scenario tmp = null;
	...
	/**
	 * @return The String representation of the {@link Scenario}s in this object, as they would be seen in a file.
	 */
	@Override
	...
	public int hashCode() {
		...
		long toOut = 0;
		for(Scenario s : op) toOut += s.hashCode();
