...
/**
 * Simple data structure for storing an Instruction, parsed from a Scenario file, designed for FRC.
 * Examples of a line from a scenario file are as such:
 * <ul><p>
 ...
 * <p></ul>
 * An Instruction may have any number of arguments to it, and the first arg is the word immediately
 * following the first word on the line. The first word on the line, if not a special indicator for
 * a delimiter or control state, will be stored in the "target" value. If the type is not a Command,
 * then "target" will contain "". Commas and periods are not included, as they are separators and not
 * necessary for the execution of an Instruction.
 * <p>
...
public class Instruction {
	...
	/**
	 * Constructs the {@link Instruction} from a raw, unprocessed line of a scenario file.
	 * <p>
	 ...
	 * <p>
	 * @param T The type of Instruction
